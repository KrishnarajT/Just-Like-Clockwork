...
import RandomSVG from "../components/ui/RandomSVG";
const Home = () => {
	...
	return (
		<div className="min-h-screen flex flex-col">
			...
			{laps.length > 0 ? (
				...
				<div
					className="flex justify-center items-center h-fit gap-16 m-10 outline p-6 rounded-xl outline-secondary min-h-64 text-2xl text-secondary flex-col"
				>
					<RandomSVG />
