  ...
  return (
    <footer className="footer footer-center px-10 bg-base-200 text-base-content rounded flex justify-between">
      <div className="label text-xl">
        Developed by <span className="text-accent link p-0 m-0" onClick={
          () => {
            window.open("https://krishnaraj.vercel.app/", "_blank");
          }
        }>Krishnaraj T</span> for Keeping track of work done.
        Feel free to contribute, or use it for yourself :)
      </div>
      ...
      >
        ...
        <button
          ...
          onClick={() => {
            window.open(
              "https://www.linkedin.com/in/krishkpt",
              "_blank"
            );
          }}
        >
