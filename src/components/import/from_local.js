...
function getFromLocalStorage() {
	...
	let laps = lapsPlain.map(lap => new WorkLap(lap.startTime, lap.endTime, lap.current_hours, lap.current_minutes, lap.current_seconds, lap.workDoneString, lap.HourlyAmount));
